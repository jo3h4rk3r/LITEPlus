...
public class ProtocolScreen extends Screen {
    ...
    public void init() {
        ...
        addButton = addDrawableChild(new ButtonWidget(width / 2 - 100, height / 2 + 50, 196, 20,Text.literal("Done"), this::onPress));
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        drawCenteredText(matrices, textRenderer, "Changes what the client says to servers.", width / 2, 15, 0xaaaaaa);
        //drawCenteredText(matrices, textRenderer, "It will only change what the client says it is to servers.", width / 2, 15, 0xaaaaaa);
        drawCenteredText(matrices, textRenderer, "* Coming Soon! *", width / 2, 20, 0xaaaaaa);
