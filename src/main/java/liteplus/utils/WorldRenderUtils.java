...
public class WorldRenderUtils {
    ...
    public static void drawText(String str, double x, double y, double z, double scale) {
        ...
        bufferbuilder.begin(null, VertexFormats.POSITION_COLOR);
    ...
    public static void glSetup(double x, double y, double z) {
        ...
        GL11.glRotatef(-mc.player.bodyYaw, 0.0F, 1.0F, 0.0F);
        GL11.glRotatef(mc.player.renderPitch, 1.0F, 0.0F, 0.0F);
